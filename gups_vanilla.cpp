...
std::uniform_int_distribution<std::uint64_t> uni(0, UINT64_MAX);
...
int main(int narg, char **arg)
{
  ...
  filename << "accessed_addresses_" << me << ".txt";
